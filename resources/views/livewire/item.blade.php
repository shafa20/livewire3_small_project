                                ...
                                @can('item.create')
                                    <div class="my-4">
                                        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"
                                            wire:click="create">Add Item </button>
                                    </div>
                                @endcan
                                @if ($isOpen)
                                    <div class="fixed inset-0 flex items-center justify-center z-50">
                                        ...
                                        <div class="relative bg-gray-200 p-8 rounded shadow-lg w-1/2">
                                            ...
                                            <form wire:submit.prevent="{{ $postId ? 'update' : 'store' }}"
                                                ...
                                                <div class="mb-4">
                                                    <label for="brand_id"
                                                        class="block text-gray-700 font-bold mb-2">Brand:</label>
                                                ...
                                                <div class="mb-4">
                                                    <label for="model_id"
                                                        class="block text-gray-700 font-bold mb-2">Model:</label>
                                                    <select wire:model="model_id" id="model_id"
                                                        class="w-full border border-gray-300 px-4 py-2 rounded">
                                                ...
                                                <div class="mb-4">
                                                    <label for="entry_date"
                                                        class="block text-gray-700 font-bold mb-2">entry_date:</label>
