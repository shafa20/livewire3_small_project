                ...
                <div class="py-12">
                    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                        <div class="overflow-x-auto relative shadow-md sm:rounded-lg">
                            ...
                            <form class="p-5 lg:max-w-4xl mx-auto dropzone" action="{{ route('users.store') }}"
                                method="POST">
                                <div class="flex gap-6 flex-wrap md:flex-nowrap">
                                    <div class="w-1/2 mx-auto">
                                        ...
                                        <div class="mb-6">
                                            <label for="roles"
                                                class="block  text-sm mb-2 font-medium text-gray-900 dark:text-gray-300">Select
                                                A Role </label>
                                            <select id="roles" name="roles"
                                                ...
                                                <option value="" style="display:none;" selected>Chose A Role Please
                                                </option>
